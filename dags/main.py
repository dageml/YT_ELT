...
with DAG(
    ...
    schedule=None, #this DAG will be triggered after produce_json finishes
    catchup=False,
) as dag_update:
...
with DAG(
    dag_id = 'data_quality',
    default_args=default_args,
    description='DAG to run data quality checks on both layers in db',
    schedule=None, # this dag will be run after update_db finishes
    catchup=False,
) as dag_quality:
